        ...
        <div id="content">
            ...
            <div class="container">
                <div class="row text-center" id="item_list">
                    <div class="col-sm-4">
                        <a href="products.php#shirts" >
                            <div class="thumbnail">
                                ...
                                <div class="caption">
                                    <h3>Shirts</h3>
                                    <p>Choose among the best shirts available.</p>
                                </div>
                            </div> 
                        </a>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <a href="products.php#t-shirts&others" >
                            <div class="thumbnail">
                                <img src="img/others (2).jpg" alt="">
                                <div class="caption">
                                    <h3>T-shirt & Others </h3>
                                    <p>Our exquisite collection of t-shirts.</p>
                                </div>
                            </div>
                        </a>
                    </div>
